...
var InternalStateModule = __webpack_require__(68);
...
var Pretty = __webpack_require__(61);
...
/* harmony import */ var core_js_modules_es_array_slice__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(53);
...
/* harmony import */ var mobile_drag_drop_scroll_behaviour__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(64);
...
var Hand = __webpack_require__(83); //Mobile browsers use the touch API - desktop is drag and drop. We'll use a polyfill so we don't have to implement both.


var mobile_drag_drop_polyfill = __webpack_require__(37).polyfill; // optional import of scroll behaviour
...
window.Tile = Tile;
window.Sequence = __webpack_require__(60);
window.Match = __webpack_require__(59);
...
document.body.appendChild(tilePlacemat); //For testing.

var tiles = new (__webpack_require__(62))().tiles;
console.log(tiles);
var wallRendering = document.createElement("div");
window.wallRendering = wallRendering;
window.Wall = __webpack_require__(62);
...
var Sequence = __webpack_require__(60);
